...
{
    internal sealed class ProcessInbox
        : ProcessInboxBase
    {
        public ProcessInbox(
    ...
    //{
    //    private readonly ConcurrentDictionary<string, Type[]> HandlersDictionary = new();
    ...
    //                    _ =>
    //                    {
    //                        return Presentation.AssemblyReference.Assembly
    //                         .GetTypes()
